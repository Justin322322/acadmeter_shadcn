...
const logTypes = {
  ...
  "grade-entry": { icon: DocumentTextIcon, bg: "bg-violet-100 dark:bg-violet-900/30", text: "text-violet-600 dark:text-violet-400" },
  ...
  "roster-update": { icon: BookOpenIcon, bg: "bg-teal-100 dark:bg-teal-900/30", text: "text-teal-600 dark:text-teal-400" },
...
const mockLogs = [
  {
    ...
    user: "Maria Johnson",
    userId: "teacher-0042",
    userEmail: "maria.johnson@school.edu",
    timestamp: "2025-03-28T09:23:14",
    description: "Teacher login from Chrome/Windows",
  ...
  },
  {
    ...
    description: "Posted 32 grades for Physics 101",
    ipAddress: "192.168.1.42"
  },
  {
    id: "log-003",
    ...
    userId: "pending-0015",
    userEmail: "r.williams@school.edu",
    timestamp: "2025-03-28T10:12:05",
    description: "New teacher sign-up request",
  ...
  },
  {
    ...
    user: "Admin User",
    userId: "admin-001",
    userEmail: "admin@acadmeter.com",
    timestamp: "2025-03-28T11:05:31",
    description: "Updated grading scale for Science department",
  ...
  },
  {
    ...
    user: "James Smith",
    userId: "teacher-0036",
    userEmail: "james.smith@school.edu",
    timestamp: "2025-03-27T16:32:45",
    description: "Exported semester grade data",
  ...
  },
  {
    ...
    description: "Created new class roster for Math 101",
    ipAddress: "192.168.1.2"
  },
  {
    id: "log-007",
    ...
    user: "System",
    userId: "system",
    userEmail: "system@acadmeter.com",
    timestamp: "2025-03-27T08:45:12",
    description: "Failed login attempt for account: j.thompson@school.edu",
  ...
  },
  {
    ...
    user: "Emily Chen",
    userId: "teacher-0018",
    userEmail: "e.chen@school.edu",
    timestamp: "2025-03-27T08:05:33",
    description: "Teacher login from Safari/MacOS",
  ...
  },
  {
    ...
    description: "Posted 28 grades for English 202",
    ipAddress: "192.168.1.65"
  },
  {
    id: "log-010",
  ...
  },
  {
    ...
    user: "Daniel Lee",
    userId: "teacher-0022",
    userEmail: "d.lee@school.edu",
    timestamp: "2025-03-26T14:18:45",
    description: "Exported attendance reports",
  ...
  },
  {
    ...
    userId: "pending-0014",
    userEmail: "s.rodriguez@school.edu",
