...
export default function SettingsPage() {
    ...
    return (
      <div className={containerClass}>
        ...
        {activeTab === 'email' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-4">Email Configuration</h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                    SMTP Server
                ...
                <div>
                  ...
                  <input
                    type="email"
                    className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800"
                    placeholder="noreply@acadmeter.com"
                  />
                </div>
              </div>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="md:hidden divide-y divide-slate-200 dark:divide-slate-700 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm">
      ...
      <div className="hidden md:grid md:grid-cols-4 gap-6">
        <Card className="md:col-span-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm">
